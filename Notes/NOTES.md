...
Create a new section for adding details that do not strictly pretain to Joker logic. It should be placed between the builder section and the side panel. Once this is finished, I can move on to adding basic styles to the entire page, and after that's complete, I can look into incorporating various libraries like spring and hover effects to make everything pop.
